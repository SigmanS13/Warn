...
if ability_count < 200 then error('unexpectedly low ability rule count'); end
if state_count < 9 then error('unexpectedly low state rule count'); end
if catalog_count < 130 then error('unexpectedly low encounter catalog count'); end
