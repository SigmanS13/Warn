...
return {
    ...
    ability_rules = {
        ...
        { id='omen_craver_impalement', content='Omen', encounter='Glassy Craver', actor='Glassy Craver', event='readies', ability='Impalement', message='HP-CRITICAL HIT + HATE RESET!\nHEAL / TANK RECLAIM', severity='critical', sound='alarm.wav', verified=true, prediction='reactive', target_shape='single', source='https://www.bg-wiki.com/ffxi/Glassy_Craver' },
        ...
        { id='omen_gin_zero_hour', content='Omen', encounter='Gin', actor='Gin', event='readies', ability='Zero Hour', message='HP-CRITICAL AOE + HATE RESET!\nINHIBIT TP FOR 60 SEC', severity='critical', sound='alarm.wav', verified=true, prediction='scripted', target_shape='radial', source='https://www.bg-wiki.com/ffxi/Gin' },
        ...
        { id='omen_ou_zero_hour', content='Omen', encounter='Ou', actor='Ou', event='readies', ability='Zero Hour', message='45%: HP-CRITICAL AOE + HATE RESET!', severity='critical', sound='alarm.wav', verified=true, prediction='scripted', target_shape='radial', source='https://www.bg-wiki.com/ffxi/Ou' },
        { id='omen_ou_target', content='Omen', encounter='Ou', actor='Ou', event='uses', ability='Target', message='30%: TARGET LOCK ACTIVE!\nCHANGE TOP HATE OR USE COVER', severity='critical', sound='alarm.wav', verified=true, prediction='scripted', target_shape='single', source='https://www.bg-wiki.com/ffxi/Ou' },
